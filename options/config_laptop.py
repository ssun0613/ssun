...
def dataset_info(dataset_name):
    ...
    if  dataset_name == 'wm_811k':
        dataset_info['data_path_train'] = '/Users/ssun/Documents/ICS/pytorch/Dataset/WM811K_dist_balanced/train_aug/'
        dataset_info['data_path_test'] = '/Users/ssun/Documents/ICS/pytorch/Dataset/WM811K_dist_balanced/test_aug/'
        ...
        dataset_info['data_path_train'] = '/Users/ssun/Documents/ICS/pytorch/Dataset/WM811K_limited/train_aug/'
        dataset_info['data_path_test'] = '/Users/ssun/Documents/ICS/pytorch/Dataset/WM811K_limited/test_aug/'
        dataset_info['data_height'] = 52
        dataset_info['data_width'] = 52
        dataset_info['batch_size'] = 40
        dataset_info['epochs'] = 20
        ...
        dataset_info['data_path_train'] = '/Users/ssun/Documents/ICS/pytorch/Dataset/single_data_1/train/'
        dataset_info['data_path_test'] = '/Users/ssun/Documents/ICS/pytorch/Dataset/single_data_1/test/'
        dataset_info['data_height'] = 52
        dataset_info['data_width'] = 52
        dataset_info['batch_size'] = 40
        dataset_info['epochs'] = 20
        ...
        dataset_info['data_path_train'] = '/Users/ssun/Documents/ICS/pytorch/Dataset/mnist/train/'
        dataset_info['data_path_test'] = '/Users/ssun/Documents/ICS/pytorch/Dataset/mnist/test/'
        dataset_info['data_height'] = 52
        dataset_info['data_width'] = 52
        dataset_info['batch_size'] = 40
        dataset_info['epochs'] = 20
...
class Config:
    ...
    def __init__(self):
        ...
        self.parser.add_argument('--network_name', type=str, default='lenet')
        self.parser.add_argument('--weight_name', type=str, default='lenet')
        self.parser.add_argument('--dataset_name', type=str, default='wm_811k_limited')
        self.parser.add_argument('--continue_train', type=bool, default=False)
        self.parser.add_argument('--epochs', type=int, default=21)
        #
        ...
        self.parser.add_argument('--dataset_path_train', type=str, default=self.dataset_info['data_path_train'])
        self.parser.add_argument('--dataset_path_test', type=str, default=self.dataset_info['data_path_test'])
        ...
        self.parser.add_argument('--freq_show_loss', type=int, default=10)
        self.parser.add_argument('--freq_show_heatmap', type=int, default=200)
        self.parser.add_argument('--freq_show_img', type=int, default=10)
        self.parser.add_argument('--freq_save_net', type=int, default=10)
